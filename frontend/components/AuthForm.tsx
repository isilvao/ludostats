...
const authFormSchema = (formType: FormType) => {
  return z.object({
    ...
    fullName:
      formType === "sign-up"
        ? z.string().min(2, "El nombre completo debe tener al menos 2 caracteres").max(50, "El nombre completo debe tener menos de 50 caracteres")
        : z.string().optional(),
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="auth-form">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <div className="shad-form-item">
                  <FormLabel className="shad-form-label">Correo Electrónico</FormLabel>
                  <FormControl>
                    <Input
          ...
          {type === "sign-up" && (
            <p className="text-sm text-center mt-4 text-neutral-500">
              ...
              y nuestra{" "}
              <Link href="/privacy-policy" className="text-[#141e3a] hover:underline">
                Política de datos
              </Link>.
            </p>
          )}
