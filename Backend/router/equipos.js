...
api.patch("/patchequipo/:id", [md_auth.asureAuth], equipoController.modificarEquipo);

// Eliminar un equipo por su ID
api.delete("/eliminarequipo/:id", [md_auth.asureAuth], equipoController.borrarEquipo);
