...
api.post('/:id_club/newtipoestadistica', tipoEstadisticasController.createTipoEstadistica) // id del club
api.patch('/:id_club/updatetipoestadistica/:id_tipoestadistica', tipoEstadisticasController.updateTipoEstadistica) // id del club y del tipo de estadistica
