...
api.post('/newtipoestadistica/:id_club', tipoEstadisticasController.createTipoEstadistica) // id del club
api.patch('/updatetipoestadistica/:id_tipoestadistica/:id_club', tipoEstadisticasController.updateTipoEstadistica) // id del club y del tipo de estadistica
api.delete('/deletetipoestadistica/:id_tipoestadistica/:id_club', tipoEstadisticasController.deleteTipoEstadistica) // id del club y del tipo de estadistica
